...
import { EQUIPOSS, TIPOS } from "../../utils/misConstantes";
          ...
          {equiposPrincipales.map((equipoPrincipal) => (
            <React.Fragment key={equipoPrincipal.id}>
              <tr>
                ...
                <td>{TIPOS[equipoPrincipal.id_tipo]}</td>
                <td>XNONEX</td>
                <td>
              ...
              {todosLosEquipos
                ...
                .map((equipoSecundario) => (
                  <tr key={equipoSecundario.id}>
                    ...
                    <td>{TIPOS[equipoSecundario.id_tipo]}</td>
                    <td>XNONEX</td>
                    <td>
                    ...
                    <td>-a-</td>
                    <td>SECUNDARIO</td>
                    <td>{equipoSecundario.id_equipo_principal}</td>
                  </tr>
                ))}
            </React.Fragment>
          ))}
